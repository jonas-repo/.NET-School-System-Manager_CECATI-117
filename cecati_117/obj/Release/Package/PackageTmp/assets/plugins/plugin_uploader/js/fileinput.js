...
(function (factory) {
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgInvalidFileType: 'Tipo de archivo invalido "{name}". Solo archivos con extension "{types}" son aceptados.',
        msgInvalidFileExtension: 'Tipo de archivo invalido "{name}". Solo archivos con extension "{extensions}" son aceptados.',
        msgFileTypes: {
            'image': 'image',
            'html': 'HTML',
            'text': 'text',
        ...
        msgUploadEnd: 'Listo',
        msgUploadEmpty: 'No hay archivos validos para subir.',
        ...
        dropZoneTitle: 'Arrastra aqui las imagenes que deseas subir &hellip;',
